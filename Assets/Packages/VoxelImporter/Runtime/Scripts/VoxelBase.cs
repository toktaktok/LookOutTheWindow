...
namespace VoxelImporter
{
    ...
    public abstract class VoxelBase : MonoBehaviour
    {
        ...
        #region Editor
        public const int EditorDataVersion = 115;
        public virtual bool EditorInitialize()
        {
            ...
            //ver1.1.5
            if (dataVersion > 0 && dataVersion < 115)
            {
        ...
        public class RefreshChecker
        {
            ...
            public int voxelFileSubIndex;
            public bool legacyVoxImport;
            public bool legacySubAssetNaming;
            ...
            public bool generateTangents;
            public bool generateVertexColors;
            public Color generateVertexColorMax;
            public Color generateVertexColorMin;
            public float meshFaceVertexOffset;
            public bool generateMipMaps;
            ...
            public virtual void Save()
            {
                ...
                shareSameMaterial = controller.shareSameMaterial;
                ...
                generateVertexColors = controller.generateVertexColors;
                generateVertexColorMax = controller.generateVertexColorMax;
                generateVertexColorMin = controller.generateVertexColorMin;
