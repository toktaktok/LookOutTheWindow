...
【サポート】
forum: https://forum.unity.com/threads/voxel-importer.533193/
mail: support@alonesoft.sakura.ne.jp
twitter: @AlSoSupport
...
【更新履歴】
Version 1.2.6
- FIX : Load From Vox Material : 不明な情報が含まれる場合に発生するエラーを修正

Version 1.2.5
- ADD : 最低動作バージョンをUnity2019.4に変更
- ADD : Mesh : アンビエントオクルージョンの頂点カラーを作成する機能追加

Version 1.2.4
- ADD : Load From Material : MagicaVoxel 0.99.6.2以降で作成されたvoxのマテリアルに対応
- FIX : Load From Material : Metallicが0の場合でもSmoothnessを設定するよう修正
- FIX : Load From Material : 半透明時にMetallicとSmoothnessを設定するよう修正

Version 1.2.3
- FIX : ScriptedImporter : Remapped Materials : Unity2019以降で複数選択時の動作に発生する問題の修正
- FIX : DaeExporter : 最新に更新

Version 1.2.2
- ADD : Unity2021.1 : 対応
- ADD : Optimize : voxのマテリアルをインポートする際に同じマテリアルを共有する設定を制御する"Share same material"フラグを追加

Version 1.2.1
- ADD : Unity2020.2 : 対応
- FIX : ScriptedImporter : Exportを有効にしている場合に2度目以降のインポートで発生するエラーの修正
- FIX : Prefabインスタンスの場合に"Remove All Voxel Importer Component"を使用できるよう変更
- FIX : Prefabの場合に"Export COLLADA(dae) File"を使用できないように変更
- FIX : VoxelFrameAnimationObject : Prefabの場合に"Export Animation Curve (Clip)"を使用できるよう変更
- FIX : Voxel Explosion : "Remove All Voxel Importer Component"で発生する問題の修正

Version 1.2.0
- ADD : Assembly Definitionに対応 (フォルダ構成変更のため、必ず既存のフォルダを削除後にインストールが必要)
- ADD : Meshなどのアセット名とチャンク名の命名規則を変更、互換性のため前の命名規則そのままにするオプションを追加
- FIX : Texture2D.SetPixelsからTexture2D.SetPixels32を使用するように変更
- FIX : Unity2020.2での警告修正
