...
namespace VoxelImporter
{
    ...
    public class VoxelSkinnedAnimationObjectBoneEditor : Editor
    {
        ...
        void OnEnable()
        {
            ...
            #region Texture
            circleNormalTex = editorCommon.LoadTexture2DAssetAtPath("Assets/VoxelImporter/Editor/Textures/Circle_normal.psd");
            circleActiveTex = editorCommon.LoadTexture2DAssetAtPath("Assets/VoxelImporter/Editor/Textures/Circle_active.psd");
            #endregion
